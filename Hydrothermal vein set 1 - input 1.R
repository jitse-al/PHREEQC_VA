...
names_output_log <-c("reaction","C.4..mol.kgw.","Ca.mol.kgw.","Cl.mol.kgw.","F.mol.kgw.","Fe.mol.kgw.","K.mol.kgw.","Mg.mol.kgw.","Na.mol.kgw.","S.6..mol.kgw.","Si.mol.kgw.","Initial_Na","Initial_K","Initial_Ca","Initial_Mg","Initial_C.4.","Initial_Alkalinity_CO3_2","Initial_S.6._SO4_2","Initial_Cl","Initial_Fe","Initial_F","Initial_Si_SiO2")
names_output_normal <- c("Alk.eq.kgw.","Alkalinity.mol.kgw.","pH","temp.C.","Solution","Initial_pH")
hist_division = 100
if(hist_division>samplesize*sample_solutions){hist_division<-samplesize*sample_solutions}


column_names_for_colliding <- list(si_Acmite =c("si_Acmite","si_acmite"),
                                   si_Aegerine =c("si_Aegerine(alpha)"),
                                   si_Anatase =c("si_Anatase"),
                                   si_Bellite =c("si_Bellite_(C2S)"),
                                   si_Calcium_silicate =c("si_C2SH(alpha)","si_C2SHa","si_CSH(1.6)","si_CSH:1.7","si_CSH1.6","si_Dicalcium_silicate"),
                                   si_Calcite =c("si_Calcite","si_calcite"),
                                   si_Chabazite =c("si_Chabazite"),
                                   si_Clinoptilolite =c("si_Clinoptilolite(Ca)","si_Clinoptilolite(K)","si_Clinoptilolite_Ca","si_Clinoptilolite_K","si_Clinoptilolite-Ca","si_Clinoptilolite-dehy-Ca","si_Clinoptilolite-dehy-K","si_Clinoptilolite-hy-Ca","si_Clinoptilolite-hy-K","si_Clinoptilolite-K","si_clptil-K"),
                                   si_Erionite =c("si_Erionite"),
                                   si_Fe_Oxide =c("si_Fe(OH)2","si_Fe(OH)2(cr)","si_Fe(OH)3","si_FeO","si_FeO(s)","si_Fe-oxide"),
                                   si_Ferrihydrite =c("si_Ferrihydrite(2L)","si_Ferrihydrite(6L)","si_Ferrihydrite(am)","si_Ferryhydrite"),
                                   si_Glaucophane =c("si_glauc-Fe"),
                                   si_Goethite =c("si_Goethite","si_goethite","si_goethite-ox"),
                                   si_Greenrust =c("si_Greenrust(OH)"),
                                   si_Hematite =c("si_Hematite","si_hematite"),
                                   si_Heulandite =c("si_heulandi","si_Heulandite(Ca)","si_Heulandite_Ca"),
                                   si_Hillebrandite =c("si_Hillebrandite"),
                                   si_Saponite =c("si_HSaponite-FeCa","si_HSaponite-FeK","si_HSaponite-FeMg","si_HSaponite-FeNa","si_Saponite(FeCa)","si_Saponite(FeK)","si_Saponite(FeMg)","si_Saponite(FeNa)","si_Saponite-FeCa","si_Saponite-FeK","si_Saponite-FeMg","si_Saponite-FeNa"),
                                   si_Ilmenite =c("si_Ilmenite"),
                                   si_Larnite =c("si_Larnite","si_larnite","si_Larnite(alpha)","si_Larnite(beta)","si_Larnite(gamma)"),
                                   si_Laumontite =c("si_Laumontite","si_laumonti"),
                                   si_Lepidocrocite =c("si_Lepidocrocite"),
                                   si_Maghemite =c("si_Maghemite(disord)","si_Maghemite(disordered)","si_Maghemite(ord)"),
                                   si_Magnetite =c("si_magnetit","si_Magnetite","si_Magnetite(am)"),
                                   si_Merwinite =c("si_merwinit","si_Merwinite"),
                                   si_Phillipsite =c("si_Phillipsite","si_Phillipsite(Ca)","si_Phillipsite(K)","si_Phillipsite_Ca","si_Phillipsite_K"),
                                   si_Quartz =c("si_Quartz","si_quartz","si_Quartz(alpha)"),
                                   si_Riebeckite =c("si_Riebeckite","si_riebecki"),
                                   si_Rutile =c("si_Rutile"),
                                   si_Siderite =c("si_Siderite","si_siderite"),
                                   si_Smectite =c("si_Smectite_Reykjanes","si_Smectite-high-Fe-Mg","si_Smectite-low-Fe-Mg"),
                                   si_Spurrite =c("si_spurrite"),
                                   si_Stellerite =c("si_Stellerite"),
                                   si_Stilbite =c("si_Stilbite","si_stilbite"),
                                   si_Ti_Oxide =c("si_Ti2O3","si_Ti3O5","si_TiO(alpha)"),
                                   si_Ulvospinel =c("si_Ulvospinel"),
                                   si_Wairakite =c("si_wairakit","si_Wairakite"),
                                   si_Wustite =c("si_Wustite"))
...
solutions_filename <- '100000_Solutions_Paper 1.csv'
  ...
  if(exists(paste('Reaction.Type.',toString(current_site),'.csv',sep=""),where = reaction_types)){
    ...
    for(current_database in used_databases){
      ...
      if(exists(paste('File',toString(current_site),'.csv',sep=""),where = eval(parse(text = paste("equilibrium_phases_all$",current_database,sep=""))))){
        ...
        if(reaction_randomizer == 'on'){
          used_reactions<-used_reactions_2[(sample(1:length(used_reactions_2[,1]),nr_randomized_reactions)),]
        }
