...
column_names_for_colliding <- list(si_Calcite =c("si_Calcite","si_calcite"),
                                   ...
                                   si_TiO =c("si_Anatase","si_Ilmenite","si_Rutile","si_Ulvospinel"),
                                   si_FeO =c("si_Fe(OH)2","si_Fe(OH)2(cr)","si_Fe(OH)3","si_FeO","si_FeO(s)","si_Fe-oxide","si_Ferrihydrite(2L)","si_Ferrihydrite(6L)","si_Ferrihydrite(am)","si_Ferryhydrite","si_goethite","si_Goethite","si_goethite-ox","si_hematite","si_Hematite","si_Lepidocrocite","si_Maghemite(disord)","si_Maghemite(disordered)","si_Maghemite(ord)","si_magnetit","si_Magnetite","si_Magnetite(am)","si_Siderite","si_siderite","si_Siderite","si_Wustite"),
                                   si_Mg_Clay =c("si_HSaponite-FeCa","si_HSaponite-FeK","si_HSaponite-FeMg","si_HSaponite-FeNa","si_Saponite(FeCa)","si_Saponite(FeK)","si_Saponite(FeMg)","si_Saponite(FeNa)","si_Saponite-FeCa","si_Saponite-FeK","si_Saponite-FeMg","si_Saponite-FeNa","si_Smectite_Reykjanes","si_Smectite-high-Fe-Mg","si_Smectite-low-Fe-Mg"),
                                   si_Pyroxene =c("si_Acmite","si_acmite","si_Aegerine(alpha)","si_glauc-Fe","si_riebecki","si_Riebeckite"),
                                   si_Zeolite_in_qtz =c("si_Clinoptilolite(K)","si_Clinoptilolite_K","si_Clinoptilolite-dehy-K","si_Clinoptilolite-hy-K","si_Clinoptilolite-K","si_clptil-K","si_Erionite","si_Phillipsite","si_Phillipsite(K)","si_Phillipsite_K"),
                                   si_Chabazite_heulandite =c("si_Chabazite","si_Clinoptilolite(Ca)","si_Clinoptilolite_Ca","si_Clinoptilolite-Ca","si_Clinoptilolite-dehy-Ca","si_Clinoptilolite-hy-Ca","si_Erionite","si_heulandi","si_Heulandite(Ca)","si_Heulandite_Ca","si_Phillipsite","si_Phillipsite(Ca)","si_Phillipsite_Ca","si_Stellerite","si_Stilbite","si_stilbite","si_Stilbite","si_wairakit","si_Wairakite"),
                                   si_Merwinite =c("si_Bellite_(C2S)","si_Hillebrandite","si_larnite","si_Larnite","si_Larnite(alpha)","si_Larnite(beta)","si_Larnite(gamma)","si_merwinit","si_Merwinite")
)
...
solutions_filename <- 'Va_Qtz_Vein_2.csv'
