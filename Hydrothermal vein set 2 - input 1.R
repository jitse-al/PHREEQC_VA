...
column_names_for_colliding <- list(si_Analcime =c("si_Analcime","si_Analcime(Si-Al_is_2.0)-Zeo19","si_Analcime(Si-Al_is_2.5)-Zeo19","si_analcite"),
                                   si_Celadonite =c("si_celad-Fe","si_celadoni","si_Celadonite","si_Celadonite(Fe)","si_Celadonite-Fe","si_Celadonite-Mg","si_Ferroaluminoceladonite"),
                                   si_Chabazite =c("si_Chabazite","si_Chabazite-Zeo19"),
                                   si_Edenite =c("si_Edenite(alpha)"),
                                   si_Glauconite =c("si_Glauconite"),
                                   si_Glaucophane =c("si_glaucoph","si_Glaucophane"),
                                   si_Heulandite =c("si_heulandi","si_Heulandite","si_Heulandite(Ca)","si_Heulandite(Ca)-Zeo19","si_Heulandite(CaKNa)-Zeo19","si_Heulandite(Na)","si_Heulandite(Na)-Zeo19","si_Heulandite_Ca","si_Heulandite_Na"),
                                   si_Kerolite =c("si_kerolite"),
                                   si_Montmorillonite =c("si_HMontmorillonite-HCCa","si_HMontmorillonite-HCK","si_HMontmorillonite-HCMg","si_HMontmorillonite-HCNa","si_montm-Ca","si_montm-K","si_montm-Na","si_Montmorillonite(HcCa)","si_Montmorillonite(HcK)","si_Montmorillonite(HcMg)","si_Montmorillonite(HcNa)","si_Montmorillonite-HCCa","si_Montmorillonite-HCK","si_Montmorillonite-HCMg","si_Montmorillonite-HCNa"),
                                   si_Nontronite =c("si_HNontronite-K","si_Nontronite(K)","si_Nontronite-Cs","si_Nontronite-K"),
                                   si_Saponite =c("si_HSaponite-Ca","si_HSaponite-FeCa","si_HSaponite-FeK","si_HSaponite-FeMg","si_HSaponite-FeNa","si_HSaponite-K","si_HSaponite-Mg","si_HSaponite-Na","si_Saponite(Ca)","si_Saponite(FeCa)","si_Saponite(FeK)","si_Saponite(FeMg)","si_Saponite(FeNa)","si_Saponite(K)","si_Saponite(Mg)","si_Saponite(Na)","si_Saponite(SapCa)9426.93","si_Saponite_SapCa","si_Saponite_SapCa(4.151H2O)","si_Saponite-Ca","si_Saponite-Cs","si_Saponite-FeCa","si_Saponite-FeK","si_Saponite-FeMg","si_Saponite-FeNa","si_Saponite-H","si_Saponite-K","si_Saponite-Mg","si_Saponite-Na"),
                                   si_Vermiculilite =c("si_HVermiculite-Ca","si_Vermiculite(Ca)","si_Vermiculite_SO","si_Vermiculite-Ca","si_VermiculiteSO"),
                                   si_Palygorskite =c("si_Palygorskite"),
                                   si_Phillipsite =c("si_Phillipsite","si_Phillipsite(Ca)-Zeo19","si_Phillipsite(K)-Zeo19","si_Phillipsite(KNa)-Zeo19","si_Phillipsite(Na)","si_Phillipsite(Na)-Zeo19","si_Phillipsite-Na","si_Phillipsite_Na"),
                                   si_Phlogopite =c("si_phlog-Na","si_phlogopi"),
                                   si_Ripidolite =c("si_Ripidolite-14A","si_Ripidolite-7A"),
                                   si_Smectite =c("si_Smectite(MX80)","si_Smectite(MX80:3.989H2O)","si_Smectite(MX80:5.189H2O)","si_Smectite_MX80(3.989H2O)","si_Smectite_MX80(5.189H2O)","si_Smectite_Reykjanes","si_Smectite-high-Fe-Mg","si_Smectite-low-Fe-Mg","si_SmectiteMX80"),
                                   si_Sepiolite =c("si_sepiolit"),
                                   si_Stilbite =c("si_Stilbite","si_Stilbite(CaKNa)-Zeo19","si_Stilbite(CaNa)-Zeo19","si_stilbite"),
                                   si_Talc =c("si_Talc","si_talc-Tsc","si_talc"),
